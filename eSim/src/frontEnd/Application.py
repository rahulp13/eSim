...
class Application(QtGui.QMainWindow):
    ...
    def initToolBar(self):
        ...
        for file in os.listdir(os.getenv('AppData') + "\\kicad"):
    ...
    def go_online_offline(self):
    	if self.online_flag:
    		os.rename(os.getenv('AppData') + "\\kicad\\fp-lib-table", os.getenv('AppData') + "\\kicad\\fp-lib-table-online")
    		os.rename(os.getenv('AppData') + "\\kicad\\fp-lib-table-offline", os.getenv('AppData') + "\\kicad\\fp-lib-table")
    		self.webConnect.setIcon(QtGui.QIcon('../../images/offline.png'))
    		self.webConnect.setText('<b>Go Online</b>')
    		self.online_flag = False
    	else:
    		os.rename(os.getenv('AppData') + "\\kicad\\fp-lib-table", os.getenv('AppData') + "\\kicad\\fp-lib-table-offline")
    		os.rename(os.getenv('AppData') + "\\kicad\\fp-lib-table-online", os.getenv('AppData') + "\\kicad\\fp-lib-table")
